...
def setor_saldo(rek,nama):
	...
	l_title=tk.Message(creditwn,text="BANK BENG",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
...
def tarik_saldo(rek,nama):
	...
	l_title=tk.Message(debitwn,text="BANK BENG",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Impact","50","bold"))
	l_title.pack(side="top")
...
def riwayat_print(rek):
	...
	l_title=tk.Message(disp_wn,text="BANK BENG",relief="raised",width=2000,
	padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Impact","50","bold"))
	l_title.pack(side="top")
	fr1=tk.Frame(disp_wn)
	fr1.pack(side="top")
	l1=tk.Message(disp_wn,text="Riwayat transaksi terakhir akun anda : ",padx=100,pady=20,width=1000,
	bg="blue",fg="orange",relief="raised")
	l1.pack(side="top")
...
def login_menu(rek,nama):
	...
	rootwn.title("BANK BENG-"+nama)
	rootwn.configure(background='orange')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	l_title=tk.Message(rootwn,text="BANK\n BENG",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Impact","50","bold"))
	l_title.pack(side="top")
...
def log_in(master):
	...
	l_title=tk.Message(loginwn,text="BANK BENG",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Impact","50","bold"))
	l_title.pack(side="top")
...
def Create():
	...
	l_title=tk.Message(crwn,text="BANK BENG",relief="raised",width=2000,padx=600,pady=0,
